                ...
                <Card>
                    <ListGroup variant="flush">
                        <ListGroup.Item>
                            ...
                            <h2>Amount: ₹ {cartItems.reduce((acc, item) => acc + item.qty * item.price, 0).toFixed(2)} </h2>
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <Button className='btn-block' disabled={cartItems.length === 0} onClick={() => checkOutHandler()}>Proceed To checkout</Button>
                        </ListGroup.Item>
                    </ListGroup>
                </Card>
            </Col>
